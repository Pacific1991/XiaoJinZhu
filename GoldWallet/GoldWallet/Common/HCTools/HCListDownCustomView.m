//
//  HCListDownCustomView.m
//  HealthClaims
//
//  Created by sdd on 2017/11/10.
//  Copyright © 2017年 fmf. All rights reserved.
//

#import "HCListDownCustomView.h"

#define ScreenWidth [UIScreen mainScreen].bounds.size.width
#define ScreenHeight [UIScreen mainScreen].bounds.size.height
#define Length 5
#define Length2 15
@interface HCListDownCustomView ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation HCListDownCustomView
...
{
    if (self.delegate && [self.delegate respondsToSelector:@selector(selectIndexPathRow:withnumber:)]) {
        
        [self dismiss];
        [self.delegate selectIndexPathRow:indexPath.row withnumber:_number];
    }
}

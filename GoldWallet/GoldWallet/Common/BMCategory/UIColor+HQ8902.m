...
@implementation UIColor (HQ8902)
//该方法一般用来将前端给的16进制颜色字符串处理成r、g、b颜色
+ (UIColor *) colorWithHexString: (NSString *)color
{
    ...
    // NSrange:分割字符串,确定检索范围  location:起点
    //length长度:把字符串的前六个字符 分成3个两个字符的字符串
    NSRange range;
    range.location = 0;
    range.length = 2;
    ...
    // Scan values       NSScanner:从NSString中提取数字,将16进制字符转化为数字
    unsigned int r, g, b;

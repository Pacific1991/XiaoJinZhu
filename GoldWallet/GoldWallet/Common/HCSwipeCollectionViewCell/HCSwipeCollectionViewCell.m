...
#import "HCSwipeCollectionViewCell.h"
#import <objc/runtime.h>

@interface UIView (SuperCollectionView)
- (UICollectionView *)HC_superCollectionView;
@end
...
NSString * const SwipeCollectionViewCurrentSwipeCell = @"HCCurrentSwipeCell";

@interface HCSwipeCollectionViewCell ()<UIGestureRecognizerDelegate>
@property (nonatomic,strong) UIView *snapShotView;
@property (nonatomic,strong) UIView *snapBackgroundView;
@property (nonatomic,strong) UIPanGestureRecognizer *panGesture;
@end
@implementation HCSwipeCollectionViewCell
...
- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer {
    return otherGestureRecognizer != self.HC_superCollectionView.panGestureRecognizer;
}
    ...
    switch (panGesture.state) {
        ...
        case UIGestureRecognizerStateCancelled: {
            ...
            if ([self _lessThenRevealViewHalfWidth] || [self _shouldHideRevealViewForVelocity:velocity]) {
                if (CGPointEqualToPoint(self.snapShotView.center, self.center)) {
                    //                    return;
                }
                [self hideRevealViewAnimated:YES];
            }
...
- (void)_closeOtherOpeningCell {
    if (self.HC_superCollectionView) {
        HCSwipeCollectionViewCell *currentCell = objc_getAssociatedObject(self.HC_superCollectionView,(__bridge const void *)(SwipeCollectionViewCurrentSwipeCell));
        if (currentCell != self) {
            [currentCell hideRevealViewAnimated:YES];
        }
        objc_setAssociatedObject(self.HC_superCollectionView, (__bridge const void *)(SwipeCollectionViewCurrentSwipeCell), self, OBJC_ASSOCIATION_ASSIGN);
    }
}

...
- (void)imageDidLongPress:(UITapGestureRecognizer *)longPress
{
    if (longPress.state == UIGestureRecognizerStateBegan) {  // 长按结束
        ...
        // change GW
        UIAlertController *actionSheet = [UIAlertController alertControllerWithTitle:@"保存图片" message:@"" preferredStyle:UIAlertControllerStyleActionSheet];
...
- (void)setPhoto:(PYPhoto *)photo
{
    ...
    NSURL *url = [NSURL imageURLWithString:urlStr];
